...
entity mstr_engine_v0 is
  port (
         ...
         last_bucket_cycle   : out std_logic_vector(31 downto 0);
...
begin
  ...
  cycles_running_lo   <= std_logic_vector(cycles_running_reg);
  last_bucket_cycle   <= std_logic_vector(last_bucket_cycles_reg);
  soft_reset_count_lo <= std_logic_vector(soft_reset_count_reg);
